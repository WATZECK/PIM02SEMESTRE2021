...
/* -------------------------------REPETIÇÃO DE TODO PROGRAMA ATÉ QUE O USUARIO DESEJE SAIR--------------------------*/


void tela_de_login(char login1[15], char senha1[15]){
